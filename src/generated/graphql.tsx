...
export type NewQueryQuery = { __typename?: 'RootQuery', faculties?: { __typename?: 'RootQueryToFacultyConnection', nodes?: Array<{ __typename?: 'Faculty', faculty_fields?: { __typename?: 'Faculty_FacultyFields', emailJson?: string | null, fieldGroupName?: string | null, firstnameEn?: string | null, firstnameTh?: string | null, lastnameEn?: string | null, lastnameTh?: string | null, phoneJson?: string | null, titleEn?: string | null, titleTh?: string | null } | null } | null> | null } | null };


export const NewQueryDocument = gql`
    query NewQuery {
  faculties {
    nodes {
      faculty_fields {
...
/**
 * __useNewQueryQuery__
 *
 * To run a query within a React component, call `useNewQueryQuery` and pass it any options that fit your needs.
 * When your component renders, `useNewQueryQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useNewQueryQuery({
 *   variables: {
 *   },
 * });
 */
export function useNewQueryQuery(baseOptions?: Apollo.QueryHookOptions<NewQueryQuery, NewQueryQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}
        return Apollo.useQuery<NewQueryQuery, NewQueryQueryVariables>(NewQueryDocument, options);
      }
export function useNewQueryLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<NewQueryQuery, NewQueryQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<NewQueryQuery, NewQueryQueryVariables>(NewQueryDocument, options);
        }
export type NewQueryQueryHookResult = ReturnType<typeof useNewQueryQuery>;
export type NewQueryLazyQueryHookResult = ReturnType<typeof useNewQueryLazyQuery>;
export type NewQueryQueryResult = Apollo.QueryResult<NewQueryQuery, NewQueryQueryVariables>;